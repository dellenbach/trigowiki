param(
  ...
  [string]$RemoteRoot = "/srv/mediawiki-staging",
  [string]$DbContainer = "mediawiki_mysql_staging",
  [string]$WikiContainer = "mediawiki_wiki_staging",
  [string]$SearchContainer = "elasticsearch_staging_lts",
